...
class SegmentTree:
    ...
    def update(self, node, i, val):
        ...
        if m>=i: self.update(node.left, i, val)
        elif m<i: self.update(node.right, i, val)
    ...
    def rangeSum(self, node, lo, hi):
        ...
        if m>=hi: return self.rangeSum(node.left, lo, hi)
        elif m<lo: return self.rangeSum(node.right, lo, hi)
